...
@Named("ITVASWeeklyReport")
public class ITVASWeeklyReport extends JiraWebActionSupport {
    ...
    @Inject
    public ITVASWeeklyReport(ProjectManager projectManager, ApplicationProperties applicationProperties,
