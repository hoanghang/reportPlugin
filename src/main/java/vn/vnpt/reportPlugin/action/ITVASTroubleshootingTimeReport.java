...
@Named("ITVASTroubleshootingTimeReport")
public class ITVASTroubleshootingTimeReport extends JiraWebActionSupport{
    ...
    @Inject
    public ITVASTroubleshootingTimeReport(ProjectManager projectManager, ApplicationProperties applicationProperties) {
