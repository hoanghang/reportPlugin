var ITVASWeeklyReport = ITVASWeeklyReport || {};

ITVASWeeklyReport.clickExport = function(){
    console.log("abc........");
}

ITVASWeeklyReport.validation = function () {
    var check = true;
...
ITVASWeeklyReport.updateProjectsByCategories = function(){
